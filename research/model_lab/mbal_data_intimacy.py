#!/usr/bin/env python3
"""
Deep data-intimacy profiling for the MBAL M1 21-year record.
...
PARQUET = PROJECT_ROOT / "mbal_history" / "opendap" / "m1_history.parquet"
OUT = PROJECT_ROOT / "mbal_data_profile"
...
def _write_md() -> None:
    R = REPORT
    L = ["# MBAL M1 Data Intimacy Profile", "",
