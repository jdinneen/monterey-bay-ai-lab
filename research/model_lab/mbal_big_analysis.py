#!/usr/bin/env python3
"""Broad leakage-aware analysis across all local MBAL-related data assets.
...
from mbal_forecast_v2 import build_hourly_matrix, load_source
...
OUT = PROJECT_ROOT / "mbal_big_analysis_results"

M1 = PROJECT_ROOT / "mbal_history" / "opendap" / "m1_history.parquet"
M2 = PROJECT_ROOT / "mbal_history" / "opendap" / "m2_history.parquet"
DRIVERS = PROJECT_ROOT / "nn_cache" / "drivers_hourly.parquet"
DRIVERS_MANIFEST = PROJECT_ROOT / "nn_cache" / "drivers_manifest.json"
NOAA_DAILY = PROJECT_ROOT / "mbal_history" / "noaa" / "noaa_drivers_daily.parquet"
NDBC = PROJECT_ROOT / "mbal_history" / "noaa" / "noaa_ndbc46042.parquet"
COOPS = PROJECT_ROOT / "mbal_history" / "noaa" / "noaa_coops.parquet"
UPWELLING = PROJECT_ROOT / "mbal_history" / "noaa" / "noaa_upwelling.parquet"
...
def _write_report(summary: dict[str, Any]) -> None:
    lines = [
        "# MBAL Big All-Data Analysis",
        "",
        "This report uses all local MBAL-related assets that can be read safely. It is exploratory: it screens signal and coverage, but it does not promote a model.",
        "",
        "## Inputs",
        "",
    ]
