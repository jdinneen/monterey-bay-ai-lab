...
## ALL
- Ranking: model BEATS the operational baseline - AP 0.7464 vs best-operational 0.6991 (delta +0.0473).
- AB411 regulatory rule: model BEATS it - model AP 0.7464 vs AB411 rain-rule AP 0.2454.
- Calibration: raw ECE 0.154 -> calibrated ECE 0.0894 vs best-operational ECE 0.0936 => deploy-ready.
...
| model_hgbt | 115647 | 24917 | 0.2155 | 0.7464 | 0.9156 | 0.882 | 0.11909 | 0.154 |
| model_hgbt_calibrated | 115647 | 24917 | 0.2155 | 0.7398 | 0.9154 | 0.8971 | 0.10938 | 0.0894 |

## EXCLUDE_SAN_DIEGO
- Ranking: model BEATS the operational baseline - AP 0.4861 vs best-operational 0.3754 (delta +0.1107).
- AB411 regulatory rule: model BEATS it - model AP 0.4861 vs AB411 rain-rule AP 0.1779.
- Calibration: raw ECE 0.2082 -> calibrated ECE 0.0169 vs best-operational ECE 0.011 => deploy-ready.
...
| model_hgbt | 89321 | 8999 | 0.1007 | 0.4861 | 0.8554 | 0.7499 | 0.13037 | 0.2082 |
| model_hgbt_calibrated | 89321 | 8999 | 0.1007 | 0.4719 | 0.8551 | 0.7822 | 0.06844 | 0.0169 |

## SAN_DIEGO_ONLY
- Ranking: model does NOT beat the operational baseline - AP 0.9387 vs best-operational 0.9389 (delta -0.0002).
- AB411 regulatory rule: model BEATS it - model AP 0.9387 vs AB411 rain-rule AP 0.6022.
- Calibration: raw ECE 0.0608 -> calibrated ECE 0.3423 vs best-operational ECE 0.1118 => NOT deploy-ready (recalibrate).
...
| model_hgbt | 26326 | 15918 | 0.6046 | 0.9387 | 0.9439 | 0.9626 | 0.08082 | 0.0608 |
| model_hgbt_calibrated | 26326 | 15918 | 0.6046 | 0.9386 | 0.9437 | 0.968 | 0.24829 | 0.3423 |

## MONTEREY
- Ranking: model BEATS the operational baseline - AP 0.4195 vs best-operational 0.2903 (delta +0.1292).
- AB411 regulatory rule: model BEATS it - model AP 0.4195 vs AB411 rain-rule AP 0.1822.
- Calibration: raw ECE 0.2629 -> calibrated ECE 0.0184 vs best-operational ECE 0.0161 => deploy-ready.
...
| model_hgbt | 5265 | 454 | 0.0862 | 0.4195 | 0.7893 | 0.6145 | 0.16062 | 0.2629 |
| model_hgbt_calibrated | 5265 | 454 | 0.0862 | 0.402 | 0.7883 | 0.6344 | 0.06386 | 0.0184 |
