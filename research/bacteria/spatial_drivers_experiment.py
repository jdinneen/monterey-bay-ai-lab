...
+spatial models. The fundable result is: +spatial lifts AP over both site-memory and the
no-spatial model AND drives Moran's I toward zero. An honest wash/regression is reported
straight.
"""
