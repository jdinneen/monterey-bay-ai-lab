...
def main(argv: list[str] | None = None) -> int:
    ...
    (out_dir / "online_recalibration.json").write_text(json.dumps(res, indent=2), encoding="utf-8")
    (out_dir / "online_recalibration.md").write_text(to_markdown(res), encoding="utf-8")
