#!/usr/bin/env python3
"""Machine-checkable senior-manager gate for MBARI AI promotion artifacts."""
...
class SrManagerGateConfig:
    ...
    def daily_learnings_path(self) -> Path:
        return self.project_root / "archive" / "reports" / "MBARI_AI_DAILY_LEARNINGS.md"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate the MBARI senior-manager promotion gate.")
    parser.add_argument(
        "--project-root",
        type=Path,
