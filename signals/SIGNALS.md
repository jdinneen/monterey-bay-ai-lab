...
- **domoic_acid** — Will a pier's next sample exceed particulate domoic acid 500 ng/L (=0.5 ng/mL)?
  - best model: DA+precursor HGBT (research/hab/da_forecast.py), ~1-week lead  ·  AP 0.232 / ROC-AUC 0.831 time-holdout; beats seasonal-naive 8/8 piers, and beats the operational NOAA C-HARM nowcast 8/8 piers (AP 0.271 vs 0.027; frozen evidence reports/hab/charm_comparison.json)
...
- **Access:** CDIP; fetcher implemented; CDIP wave parquet is not committed in the public tree.
- **bacteria_exceedance:** `WASH` — wave-network gate ΔAP 0.0000 (<0.005 noise threshold) — `reports/bacteria/new_source_signal_gate/verdicts.json`
...
- **bacteria_exceedance:** `WASH` — no shipped public evidence artifact supports a transferable lift; retest de-tided surge residual before claiming any tide feature.
