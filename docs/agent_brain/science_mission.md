...
The project and lab are **Monterey Bay AI Lab**. MBAL is acceptable as shorthand
or as an internal/legacy code-namespace token (module/file names, MBAL_* env vars,
paths). Agents must not describe the project as MBARI, MBARI AI, MBARI AI Lab, or
MBARI AI Forecasting. MBARI may appear only when factually naming the M1/M2 mooring
data provider.
